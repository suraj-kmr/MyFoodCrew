<div class="row">
    ...
    <div class="col-sm-3">
        <a class="btn btn-success" href="<?= admin_url('books/export_all'); ?>">Export All Products</a>
    </div>
...
<div class="box box-header box-status">
    ...
    <label class="checkbox-inline"><form name="show" method="get" action="<?= admin_url('products'); ?>">
    ...
    <a href="<?= admin_url('books/add'); ?>" class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus-circle"></i> Add Book</a>
...
<div class="row form-search">
    <div class="col-sm-6">
        <form method="get" action="<?= admin_url ('books'); ?>">
                    ...
                    foreach($products as $p){
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if($p -> status == 1){
                                    ?>
                                    <a href="<?= admin_url('books/deactivate/' . $p -> id, true); ?>" class="label label-success">Active</a>
                                <?php
                                }else{
                                    ?>
                                    <a href="<?= admin_url('books/activate/' . $p -> id, true); ?>" class="label label-danger">Deactive</a>
                                <?php
                                }
                                ?>
                            </td>
                            ...
                            <td>
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="<?= admin_url('books/add/'. $p -> id); ?>" title="Edit" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i> </a>
                                    <a href="<?= admin_url('books/delete/'. $p -> id); ?>" title="Delete" class="btn btn-xs btn-danger delete"><i class="fa fa-trash"></i> </a>
                                </div>
                            </td>
                        </tr>
                    <?php
...
<script type="text/javascript">
    ...
    function submit(type){
        ...
        if (r == true) {
            var url = '<?php echo admin_url('books'). '/'; ?>' + type;
