<div class="page-header">
	...
	<table class="table table-bordered table-striped">
		...
		foreach($medias as $row){
			...
			<tr>
				<td align="center">
				<a href="<?php echo base_url(upload_dir()).$row -> file_name; ?>" target="_blank">
				<?php if($row -> is_image){ ?>
					<img src="<?php echo base_url(upload_dir()).$row -> file_name; ?>" width="50">
				...
				<td><?php echo base_url(upload_dir()).$row -> file_name; ?></td>
				<td align="center">
