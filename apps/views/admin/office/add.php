...
<?php echo form_open_multipart(admin_url('office/add/'.$p -> id), array('class' => 'form-horizontal')); ?>
<input type="hidden" name="frm[product_type]" value="7" />
<div class="col-sm-9">
