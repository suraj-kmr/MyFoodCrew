...
<?php echo form_open_multipart(admin_url('tech_accessories/add/'.$p -> id), array('class' => 'form-horizontal')); ?>
<input type="hidden" name="frm[product_type]" value="<?= COMPUTERS ?>" />
<div class="col-sm-9">
...
$type = array('product_type'=> COMPUTERS);
