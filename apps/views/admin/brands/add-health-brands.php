...
<form enctype="multipart/form-data" method="post" action="<?php echo admin_url('brands/add_health_brands/'.$m->id); ?>" class="form-horizontal">
	<div class="row">
		<div class="col-md-12">
			<p class="pull-right">
		...
		<div class="box-p">
			...
			<div class="form-group">
				<div class="col-sm-6 col-sm-offset-2">
					...
					<a href="<?php echo admin_url('brands/health'); ?>" class="btn btn-sm btn-danger btn-round" ><i class="fa fa-times"></i> Cancel</a>
				</div>
			</div>
		</div>
	</div>
