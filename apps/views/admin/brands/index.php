...
<!-- <div class="row">
	<div class="col-md-12">
		<p class="pull-right">
			<a href="<?php echo site_url('admin/brands/add_cloth_brands'); ?>" class="btn btn-sm btn-primary tooltips" title="Add New"><i class="glyphicon glyphicon-plus">Add</i>
			</a>
				...
				<?php if (count($data) > 0) { ?>
					<?php foreach($data as $row) { ?>
						...
						<tr>
							...
							<td class="center">
								<div class="btn-group">
									<a title="Edit" class="btn btn-xs btn-default" href="<?php echo admin_url('brands/add_cloth_brands') . '/' . $row->id; ?>"><i class="fa fa-pencil"></i> </a>
									<a title="Delete" class="btn btn-xs btn-danger delete" href="<?php echo admin_url('brands/delete_cloths') . '/' . $row->id; ?>"><i class="fa fa-trash"></i></a>
								</div>
							</td>
						</tr>
