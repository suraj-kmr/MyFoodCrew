...
<?php echo form_open_multipart(admin_url('clothings/combo_add/'.$p -> id), array('class' => 'form-horizontal')); ?>
...
<div class="tab-content">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <input type="text" name="frm[slug]" value="combo-tshirts" class="form-control input-sm" />
    ...
    <?php
    $lbl1 = $lbl2 = $price1 = $price2 = '';
    if($p->id != '')
    {
        $data = $this->db->get_where('combo_prod', array('prod_id' => $p->id));
        if($data->num_rows() > 0)
        {
            $d = $data->row();
            $lbl1 = $d->lbl1;
    ...
    <div class="form-group">
        ...
        <label class="col-sm-2 control-label">Product For </label>

        <div class="col-sm-5">

            <input type="text" name="lbl1" value="<?= set_value('lbl1', $lbl1); ?>" class="form-control input-sm" placeholder="Label Text 1" />

        </div>
        <div class="col-sm-5">

            <input type="text" name="lbl2" value="<?= set_value('lbl2', $lbl2); ?>" class="form-control input-sm" placeholder="Label Text 2" />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            ...
            <input type="text" name="price1" value="<?= set_value('price1', $price1); ?>" class="form-control input-sm" placeholder="Price 1" />

        </div>
        <div class="col-sm-5">

            <input type="text" name="price2" value="<?= set_value('price2', $price2); ?>" class="form-control input-sm" placeholder="Price 2" />
