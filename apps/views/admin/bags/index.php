<div class="row">
    ...
    <div class="col-sm-3">
        <a class="btn btn-success" href="<?= admin_url('bags/export_all'); ?>">Export All Products</a>
    </div>
...
<div class="box box-header box-status">
    ...
    <a href="<?= admin_url('bags/import_files'); ?>" style="margin-left:5px;" class="btn btn-sm btn-warning pull-right"> <i class="fa fa-upload"></i> Import File</a>
    <a href="<?= admin_url('bags/add'); ?>" class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus-circle"></i> Add New Product</a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.box-status input').on('click', function(){
            var v = $(this).val();
            if(v == 1){
                window.location.href="<?= admin_url('bags/index?status=active'); ?>"
            }else if(v == 0){
                window.location.href="<?= admin_url('bags/index?status=inactive'); ?>"
            }else{
                window.location.href="<?= admin_url('bags/index'); ?>"
            }
        });
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="<?= admin_url('bags/add/'. $p -> id); ?>" title="Edit" class="btn btn-xs btn-info"><i class="fa fa-pencil"></i> </a>
                                    <a href="<?= admin_url('bags/delete/'. $p -> id); ?>" title="Delete" class="btn btn-xs btn-danger delete"><i class="fa fa-trash"></i> </a>
                                </div>
                            </td>
                        </tr>
                    <?php
