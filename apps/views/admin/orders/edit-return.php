...
<?php echo form_open_multipart(admin_url('orders/edit-return/'. $order_id), array('class' => 'form-horizontal')); ?>
<?php
$courier = '';
if(isset($tracks) && count($tracks) > 0){
	$reason = $tracks[0] -> reason_for_return;
			...
			<div class="widget-content">
				<table class="table">
					...
					<tr>
						...
						<td>
							<select name="tr[status]" class="form-control input-sm">
								...
								<option value="1" <?php if($status == '1') { echo "selected";}?>>Returned</option>
					...
					<tr>
						<td></td>
						<td>
							<input type="submit" name="btn_update" value="Update" class="btn btn-sm btn-info" />
						</td>
					</tr>
					</tbody>
				</table>
	...
	<div class="col-sm-8">
		<div class="box">
			<div class="box-header">
				<h4 class="box-title"><b>Returning Orders</b></h4>
			</div>
