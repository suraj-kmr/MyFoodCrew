...
<?php echo form_open_multipart(admin_url('home_accessories/add/'.$p -> id), array('class' => 'form-horizontal')); ?>
<input type="hidden" name="frm[product_type]" value="<?= HOMEKITCHEN ?>" />
<div class="col-sm-9">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                ...
                if(is_array($brand) && count($brand) > 0){
                    ...
                    echo form_dropdown('frm1[brand]', $d, set_value('frm1[brand]', $office->brand), 'class="form-control input-sm"');
                }
                ?>
            ...
            <div class="col-sm-2">
                    ...
                    echo form_dropdown('frm1[material]', $d, set_value('frm1[material]', $office->material), 'class="form-control input-sm"');
                    }
                    ?>
            ...
            <div class="col-sm-2">
                ...
                if(is_array($theme) && count($theme) > 0){
                    ...
                    echo form_dropdown('frm1[theme]', $d, set_value('frm1[theme]', $office->theme), 'class="form-control input-sm"');
                }
                ?>
            </div>
...
$type = array('product_type'=> HOMEKITCHEN);
